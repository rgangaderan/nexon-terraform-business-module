...
module "ec2-autoscaling" {
  source = "git@github.com:rgangaderan/terraform-modules//aws/ec2-autoscaling?ref=v2.1.0"
...
module "elb" {
  source = "git@github.com:rgangaderan/terraform-modules//aws/elb?ref=v2.1.0"
...
module "elb_attachment" {
  source = "git@github.com:rgangaderan/terraform-modules//aws/elb_attachment?ref=v2.1.0"
